// presets.js — build volumes of popular printers (mm). Typical catalog values.
export const PRESETS = [
  { id: 'custom',     name: 'Custom…',                 build: [256, 256, 256] },
  ...
  { id: 'h2d',        name: 'Bambu Lab H2D',           build: [325, 320, 325] },
